//// In your Mat4.cpp or a dedicated instantiation file
//#include "matrix_types.h"
//
//namespace ar::mat {
//    // Explicit template instantiations
//    template struct Mat<float, 4, 4>;
//    template Mat<float, 4, 4> Identity<float>();
//    template Mat<float, 4, 4> Transpose<float>(const Mat<float, 4, 4>&);
//    template Mat<float, 4, 4> Diagonal<float>(const Vec4T<float>&);
//    template Vec4T<float> operator*<float>(const Mat<float, 4, 4>&, const Vec4T<float>&);
