...
namespace ar
{
	...
	ar::VertexBuffer* VertexBuffer::Create(std::vector<VertexPositionIDColor> vertices)
	{
		switch (RendererAPI::GetAPI())
		{
		case RendererAPI::API::None:
		...
		{
			return new OGLVertexBuffer(vertices.data(),
				static_cast<unsigned int>(vertices.size()) * sizeof(VertexPositionIDColor),
				static_cast<unsigned int>(vertices.size()), VertexPositionIDColor::s_Layout);
		}
		default:
			return nullptr;
		}
	...
	ar::VertexBuffer* VertexBuffer::Create(std::vector<VertexPositionUVID> vertices)
	{
		switch (RendererAPI::GetAPI())
		{
		case RendererAPI::API::None:
		...
		{
			return new OGLVertexBuffer(vertices.data(),
				static_cast<unsigned int>(vertices.size()) * sizeof(VertexPositionUVID),
				static_cast<unsigned int>(vertices.size()), VertexPositionUVID::s_Layout);
		}
		default:
			return nullptr;
		}
